...
| Default legacy profile input | `dsh-desktop-eac-ui-skin-profile@^0.3` | EAC ADR 0009 | current EAC static package | migration tooling | Migration input only; converted to the exact frozen profile during manager packaging |
